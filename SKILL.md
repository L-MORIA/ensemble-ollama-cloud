...
|------|--------|----------------|
| 🏆 **Арбитр** | `nemotron-3-ultra:cloud` | NVIDIA 550B, 1M ctx, глубокая аналитика (10-172s) |
...
- Nemotron-3 Ultra медленный (10-172s на задачу)
...
| `nemotron-3-ultra:cloud` | 10s | 40 | 172s | 1 446 |
...
6. **Nemotron-3 Ultra иногда timeout** — повторить запрос (10-172s в зависимости от сложности)
...
- [ ] `curl -X POST ... nemotron-3-ultra:cloud` — модель отвечает
